...
<body>
    ...
    // echo $pid;
    // exit();
    $product_query = "SELECT * FROM monitor_details where monid='$pid'";
    $result = $connect_db->query($product_query);
    if ($result->num_rows > 0) {
        while ($product = $result->fetch_assoc()) {
            $data[1]['pid'] = $pid;
            $data[1]['name'] = $product['monName'];
            $data[1]['price'] = $product['monPrice'];
    ?>
                            ...
                            <div id="hpCarousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner p-1">
                                    <div class="carousel-item active">
                                        <img class="img-fluid" src="images/products/monitor/<?php echo $pid; ?>/mon1.jpg" alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="img-fluid" src="images/products/monitor/<?php echo $pid; ?>/mon2.jpg" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="img-fluid" src="images/products/monitor/<?php echo $pid; ?>/mon3.jpg" alt="Third slide">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <ol class="breadcrumb" style="background-color: white;">
                                <li class="breadcrumb-item">
                                    <a href="/pcs/product_archive_page.php/?category=monitor" style="color: #616a7f;">Monitor</a>
                                </li>
                                <li class="breadcrumb-item active" style="color: #2d3956;"><?php echo $product['monCompany']; ?></li>
                            </ol>
                            <div class="col-md-12">
                                <h6 class="comp"><?php echo $product['monCompany']; ?></h6>
                                <h2><?php echo $productName = $product['monName']; ?></h2>
                                <div>
                                ...
                                <h1 class="text-danger">₹ <span><?php echo $price = $product['monPrice']; ?></span></h1>
                                <div class="row">
                                    <div class="col-md-6 p-1">
                                        <form action="" method="post">
                                            ...
                                            <input type="hidden" name="productImg" value="/monitor/<?php echo $pid; ?>/mon1.jpg">
                                        </form>
                                    </div>
                ...
                <div class="pt-4">
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active p-2" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <p class="description p-1"> <?php echo $product['monDescription']; ?></p>
                        </div>
                        <div class="tab-pane fade p-2" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <table class="table table-striped table-dark">
                                <tbody>
                                    <tr>
                                        <td>Name</td>
                                        <td><?php echo $product['monName']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Company</td>
                                        <td><?php echo $product['monCompany']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Price</td>
                                        <td>₹ <span><?php echo $product['monPrice']; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td>Screen Size</td>
                                        <td><?php echo $product['monScreenSize']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Resolution</td>
                                        <td><?php echo $product['monResolution']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Aspect Ratio</td>
                                        <td><?php echo $product['monAspectRatio']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Display Ports</td>
                                        <td><?php echo $product['monDisplayPorts']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Refresh Rate</td>
                                        <td><?php echo $product['monRefreshRate']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
