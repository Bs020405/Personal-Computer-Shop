...
<body>
    ...
    // echo $pid;
    // exit();
    $product_query = "SELECT * FROM laptop_details where ltpid='$pid'";
    $result = $connect_db->query($product_query);
    if ($result->num_rows > 0) {
        while ($product = $result->fetch_assoc()) {
            $data[1]['pid'] = $pid;
            $data[1]['name'] = $product['ltpName'];
            $data[1]['price'] = $product['ltpPrice'];
    ?>
                            ...
                            <div id="hpCarousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner p-1">
                                    <div class="carousel-item active">
                                        <img class="img-fluid" src="/pcs/images/products/laptop/<?php echo $pid; ?>/ltp1.jpg" alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="img-fluid" src="/pcs/images/products/laptop/<?php echo $pid; ?>/ltp2.jpg" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="img-fluid" src="/pcs/images/products/laptop/<?php echo $pid; ?>/ltp3.jpg" alt="Third slide">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <ol class="breadcrumb" style="background-color: white;">
                                <li class="breadcrumb-item">
                                    <a href="/pcs/product_archive_page.php/?category=laptop" style="color: #616a7f;">Laptop</a>
                                </li>
                                <li class="breadcrumb-item active" style="color: #2d3956;"><?php echo $product['ltpCompany']; ?></li>
                            </ol>
                            <div class="col-md-12">
                                <h6 class="comp"><?php echo $product['ltpCompany']; ?></h6>
                                <h4><?php echo $productName = $product['ltpName']; ?></h4>
                                <div>
                                ...
                                <h1 class="text-danger">₹ <span><?php echo $price = $product['ltpPrice']; ?></span></h1>
                                <div class="row">
                                    <div class="col-md-6 p-1">
                                        <form action="" method="post">
                                            ...
                                            <input type="hidden" name="productImg" value="/laptop/<?php echo $pid; ?>/ltp1.jpg">
                                        </form>
                                    </div>
                                    <div class="col-md-6 p-1">
                ...
                <div class="pt-4">
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active p-2" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <p class="description p-1"> <?php echo $product['ltpDescription']; ?></p>
                        </div>
                        <div class="tab-pane fade p-2" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <table class="table table-striped table-dark">
                                <tbody>
                                    <tr>
                                        <td>Name</td>
                                        <td><?php echo $product['ltpName']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Company</td>
                                        <td><?php echo $product['ltpCompany']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Price</td>
                                        <td>₹ <span><?php echo $product['ltpPrice']; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td>Processor</td>
                                        <td><?php echo $product['ltpProcessor']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Graphics</td>
                                        <td><?php echo $product['ltpGraphics']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>RAM</td>
                                        <td><?php echo $product['ltpRAM']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Screen Size</td>
                                        <td><?php echo $product['ltpScreenSize']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Screen Refresh Rate</td>
                                        <td><?php echo $product['ltpScreenRefreshRate']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Storage Configuration</td>
                                        <td><?php echo $product['ltpStorage']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Operating System</td>
                                        <td><?php echo $product['ltpOS']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Connectivity Ports</td>
                                        <td><?php echo $product['ltpPorts']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
